...
summary: 指令碼文件- Microsoft團隊提供AVD 
keywords:  
---
= 指令碼活動文件- Microsoft Team for AVD
:allow-uri-read: 
...
image::scriptlibrary.activity.InstallMicrosoftTeamsAVD.png[指令碼library.activity。安裝Microsoft TeamsAVD]
